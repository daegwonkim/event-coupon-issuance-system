package io.github.daegwonkim.event_coupon_issuance_system.service.v6;
...
public class CouponServiceV6 implements ICouponService {
    ...
    @Override
    @DistributedLock(key = "'coupon:' + #request.couponId()")
